...
AEGIS'e bir hedef ve kapsam verin. Gerisini o halleder.
...
AEGIS bir **ReAct döngüsü** çalıştırır — Düşün, Harekete Geç, Gözlemle, Yansıt — angajman tamamlanana veya tüm hedefler karşılanana kadar kesintisiz devam eder.

```
Operatör:  "192.168.1.0/24'ü tara, bulduklarını exploit et, sızma sonrası veri topla."

AEGIS:     [Düşünce]    Henüz host keşfedilmedi. Ping sweep başlatılıyor.
...
AEGIS iki modda çalışır: **web arayüzü** (varsayılan) ve **terminal** (başsız).
...
AEGIS her eylemde on yapılandırılabilir güvenlik kısıtlaması uygular. Bu kısıtlamalar LLM tarafından aşılamaz — herhangi bir araç çalışmadan önce ayrı bir katmanda değerlendirilir.
...
Yapılandırılmış angajmanlar için AEGIS, kapsam, izinler, kimlik bilgileri ve hedefleri kontrol eden bir `MissionBrief` yapılandırması kabul eder.
...
AEGIS üç aşamada geliştirilmektedir. V1 ağ düzeyinde temelidir — sonraki her şey eklenti olarak gelir.
...
XBOW, otonom yapay zeka sızma testi için mevcut ticari referans noktasıdır. AEGIS açık kaynak alternatifidir.

| Yetenek | XBOW | AEGIS V1 | AEGIS V2+ |
|---------|------|----------|-----------|
...
AEGIS eklenti ekosistemi aracılığıyla büyümektedir. Katkılar memnuniyetle karşılanır:
...
[AEGIS Ticari Olmayan Lisansı](LICENSE) — Kişisel, eğitimsel ve araştırma kullanımı için ücretsizdir. Ticari kullanım, yazarlardan açık yazılı izin gerektirir.

---

<div align="center">

[Bu depoyu yıldızla](https://github.com/fthsrbst/aegis) · [Hata bildir](https://github.com/fthsrbst/aegis/issues) · [Özellik talep et](https://github.com/fthsrbst/aegis/issues)
