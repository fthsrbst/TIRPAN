...
import { ShieldAlert, Shield, AlertTriangle, Info, BarChart3 } from "lucide-react";
...
// ── Attack-phase inference from vulnerability fields ───────────────────────────
// Used when _cls is not yet stored in the DB (vulnerabilities table has no _cls column).
      ...
      <div className="flex flex-col h-full gap-3">
        ...
        <div className="node-card !p-3 shrink-0">
          <ListFilterToolbar
            ...
            searchPlaceholder="Title, CVE, service, target..."
        ...
        <div className="flex-1 min-h-0 node-card overflow-hidden flex flex-col">
          <div className="overflow-auto flex-1">
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                {isLoading&&<tr><td colSpan={7} className="px-4 py-8 text-xs text-muted-foreground text-center">Loading findings...</td></tr>}
                {!isLoading&&filtered.length===0&&<tr><td colSpan={7} className="px-4 py-8 text-xs text-muted-foreground text-center">No findings match your filters.</td></tr>}
