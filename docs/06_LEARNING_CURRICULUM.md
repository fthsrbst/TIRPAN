# PenTestAI — Learning Curriculum

## How This Project Teaches You to Code

Each phase of building PenTestAI teaches you specific programming concepts. You'll go from beginner-intermediate to someone who can build complex AI-powered systems.
